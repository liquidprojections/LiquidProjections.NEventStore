...
Task("Restore-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetRestore("./LiquidProjections.NEventStore.sln", new NuGetRestoreSettings 
	{ 
		NoCache = true,
    ...
    .Does(() =>
{
    ...
    {
      // Use MSBuild
      MSBuild("./LiquidProjections.NEventStore.sln", settings => {
    ...
    {
      // Use XBuild
      XBuild("./LiquidProjections.NEventStore.sln", settings =>
        settings.SetConfiguration(configuration));
    }
});
